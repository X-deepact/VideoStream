...
const LivestreamSessions = ({ defaultStatus, pageTitle }:SessionBaseProps) => {
	...
	return (
		<div className="px-8">
							...
							<div className="grid gap-4 py-4">
								<div className="grid grid-cols-3 items-center gap-4">
									<Label htmlFor="category"
									       className="text-left">Category</Label>
									<Select
										id="category"
										value={streamType}
										onValueChange={(value) => {
			...
			<div
				className="mt-10 mb-4 w-full m-auto items-center flex justify-between">
				<div className="flex flex-row">
					...
					/>
					<span
						className="ml-2 text-lg font-bold">of {totalPages} on showing {quantities} of total {totalItems} livestreams.
					</span>
				</div>
